...
for institution in institutions:
    ...
    agreement = json.loads(assistorgapi.get_agreements("120", institution_id, "74", 'major'))
    desired_label = "Computer Engineering, B.S."
    ...
    output_file_path = "./uci/"+institution_id+".json"
    try:
